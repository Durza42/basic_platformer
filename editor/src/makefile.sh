...
g++ -std=c++17 -Wall -Wextra main.o Context.o Game.o Input.o utilities.o -o ../exec/editor.elf `!sdl2-config --libs` -lSDL2_image -lSDL2_mixer

rm Context.o Game.o Input.o main.o utilities.o
